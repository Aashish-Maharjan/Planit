...
export const createTask= async(req,res)=>{
    try {
        ...
        text=
            text+`The task priority is set a${priority},priority,so check and act accordingly.The task date is${new Date(date).toDateString()}.Thankyou!!!`;
